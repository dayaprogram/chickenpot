						...
						<div class="col-md-12">	
							...
							<div class="cart-pro-detail">
									...
									<div class="food-pro">
										...
										<span><?php echo $data['foodname']; ?></span>
									</div>
									
									<div class="price">
										<span><?php echo $data['foodprice'];?></span>
									</div>
									...
									<div class="total">
										<span id="calculatePrice"><?php echo ($data['foodprice'] * $data['quantity']); ?></span>
									</div>
									
									<div class="cancel">
									<a href="javascript:;" onclick="return deleteItem(<?php echo $data['id']; ?>);"><i class="icon-cancel"></i></a>
									</div>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="cart-total">
								<h5>Cart Totals</h5>
								<div class="total-sec">
									<div class="sub-total-sec"> <span class="left">Cart Subtotal</span> <span class="right"> <span>SUBTOTAL: <strong>$<?= $subtotal ?></strong></span></span> </div>
									<div class="sub-total-sec"> <span class="left">Shipping</span> <span class="right">Free Shipping</span> </div>
									<div class="order-total"> <span class="left">Order Total</span> <span class="right">$<?= $subtotal ?></span> </div>
						...
						<div class="col-md-5">
							<div class="on-delivery"><a href="customer-info.html">cash on delivery</a></div>
						</div>
