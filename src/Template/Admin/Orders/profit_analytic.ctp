        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="text-align: center;"> 
                    <a class="quick-btn" href="javascript:void(0)"> <i class="fa fa-shopping-cart" aria-hidden="true" ></i> <span> Profit </span> 
                        <span class="label label-success"><?php echo number_format((float)$sum,2,'.',',');?></span>  </a>
                        ...
                        <table class="table table-bordered sortableTable responsive-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Qty<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                    <th>Amount(&pound;)<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                    <th>Selling Price(&pound;)<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                    <th>Costing(&pound;)<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                    <th>Profit(&pound;)<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                    <th>Action<i class="icon-sort"></i><i class="icon-sort-down"></i> <i class="icon-sort-up"></i></th>
                                </tr>
                            </thead>
...
<script>
    ...
    {
        $.post("<?php echo $this->request->webroot?>admin/orders/profit_graph",$("#ChartForm").serialize(),function(data)
        {
        var range=[0,1];
        var table="";
        ...
        index++;    
        table+="<tr><td>"+index+"</td><td>"+value.name+"</td><td>"+value.email+"</td><td>"+value.date+"</td><td>"+value.qty+"</td><td>"+value.amt+"</td><td>"+value.net_sellingprice+"</td><td>"+value.net_costing+"</td><td>"+value.net_profit+"</td><td><a href='<?php echo $this->request->webroot?>admin/orders/details/"+value.id+"'> <button class='btn-btn-info btn-xs'><i class='icon-eye-open'></i> View</button> </a></td></tr>";    
            
        });
      }
      else
      {
        table="<tr><td colspan=8>No Transaction Found</td></tr>";    
