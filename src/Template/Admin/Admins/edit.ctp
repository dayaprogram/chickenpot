            ...
            <div class="col-lg-12">
                <div class="box">
				  ...
				  <?php echo $this->Form->create($doctor,['class' => 'form-horizontal', 'id' => 'user-validate']);?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Permissions</label>
                                    <div class="col-lg-8"> 
                                        <?php foreach($menus as $menu)
                                            { ?>
                                                <div class="col-lg-1">
                                                    <input type="checkbox" name="allpermissions[]" value="<?php echo $menu->id; ?>" <?php echo (!empty($this->request->data['allpermissions']) && in_array($menu->id, $this->request->data['allpermissions']))?'checked':''; ?>>
                                                </div>
                                                <div class="col-lg-7">
                                                    <?php echo $menu->menu; ?>
                                                </div>
