            ...
            <div class="col-lg-12">
                <div class="box">
				  ...
				  <?php echo $this->Form->create($sitesettings,['class' => 'form-horizontal', 'id' => 'siteset-validate', 'type' => 'post', 'enctype' => 'multipart/form-data']);?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Post Card Price</label>
                                    <div class="col-lg-8">
                                        <input type="text" id="card_price" name="card_price" class="form-control" value="<?php echo $sitesettings->card_price;?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
