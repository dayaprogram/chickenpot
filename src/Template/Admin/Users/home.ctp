        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="text-align: center;"> 
                    ...
                    { ?>
                    <a class="quick-btn" href="<?php echo $this->Url->build(["controller" => "Users", "action" => "listdoctor"]); ?>"> <i class="fa fa-user" aria-hidden="true"></i> <span> User </span> 
                        <span class="label label-success"><?php echo $total_user; ?></span> </a> 
                    <?php
                    } ?>
                    <!-- <?php if(!empty($admin_permissions) && in_array(19, $admin_permissions))
                    { ?>
                    <a class="quick-btn"  href="<?php echo $this->Url->build(["controller" => "Properties", "action" => "index"]); ?>"> <i class="fa fa-th-list" aria-hidden="true"></i> <span> Property </span>
