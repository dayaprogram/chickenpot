                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        ...
                                                        <?php if ($dt->is_active == 1) { ?>
                                                            <a href="<?php echo $this->Url->build(["action" => "chstatus", $dt->id, '0']); ?>"> <button class="btn btn-info btn-xs"><i class="icon-thumbs-down"></i> Suspend</button> </a>
                                                        <?php } else if ($dt->is_active == 0) { ?>
                                                            <a href="<?php echo $this->Url->build(["action" => "chstatus", $dt->id, '1']); ?>"> <button class="btn btn-success btn-xs"><i class="icon-thumbs-up"></i> Active</button> </a>
                                                        <?php } ?>                                                        
                                                    </td>                
                                                </tr>
                                        <?php $i++; endforeach; ?>
