                        ...
                        <div class="detail">
                            <h3>Chicken Pot<h3>
                                    ...
                                    <ul>
                                        ...
                                        <li class="location"><i class="icon-home"></i> <span>Shop No. 50,Chotti Baradari Part 1,Jalandhar</span></li>
                                    </ul>
                                    </div>
                                    </div>
                                    </div>
                                                    ...
                                                    <div class="field">
                                                        ...
                                                        <form name="newsletter_form" id="newsletter_form" method="post" onSubmit="return false">
                                                            <input name="nws_email_address" id="nws_email_address" type="text" 
                                                                   ...
                                                                   onfocus="if (this.value === 'Enter your e-mail address') {
                                                                               this.value = ''
                                                                           }"
