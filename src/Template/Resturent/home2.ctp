...
<div class="tp-banner-container">
    <div class="scroll-down bounce"><a class="arrow-scroll" href="#intro"><img src="<?php echo $this->request->webroot; ?>chickenpot/images/arrow-scroll.png" alt=""></a></div>
    ...
    <div class="tp-banner" >
        <ul>
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="on"  data-title="Intro Slide">
                ...
                <img src="images/slides/banenr-img5.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                ...
                <div class="tp-caption arrowicon customin  rs-parallaxlevel-10"
                     ...
                     data-endspeed="1000"
                     style=""><img src="<?php echo $this->request->webroot; ?>chickenpot/images/slides/flower.png" alt="" >
                </div>
                ...
                <div class="tp-caption grey_heavy_72 customin randomrotateout tp-resizeme rs-parallaxlevel-10"
                     ...
                     data-endelementdelay="0.1"	
                     data-endspeed="1000"
                     style="font-size:72px; z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">real food
                </div>
...
<div class="content">
    ...
    <div class="today-special">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="today-special-detail">
                        <div class="main-sec">

                            <div class="detail">
                                <span class="title">Today Special</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ac tortor at tellus feugiat congue quis consectetur adipiscing.</p>
                            </div>

                            <div class="image">
                                <img src="images/today-special-img.jpg" alt="">
                            </div>
                ...
                <div class="serv-main-sec">
                    ...
                    <div class="col-md-4">
                        <div class="service-sec">
                            ...
                            <img src="<?php echo $this->request->webroot; ?>chickenpot/images/services-img2.jpg" alt="">

                            <div class="detail">
                                <h6>Welcome to Pearl</h6>
                                <p>Lorem ipsum porta placerat rutrum aliquet platea accumsan, molestie eros aliquet adipiscing egestas ultrices.</p>
                    ...
                    <div class="col-md-4">
                        <div class="service-sec">
                            <img src="<?php echo $this->request->webroot; ?>chickenpot/images/services-img3.jpg" alt="">

                            <div class="detail">
                                <h6>Fresh & Hot Food</h6>
                                <p>Lorem ipsum porta placerat rutrum aliquet platea accumsan, molestie eros aliquet adipiscing egestas ultrices.</p>
                                <a href="menu3.html">our menu</a>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>chickenpot/images/our-story.jpg" alt="">
                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="booking-form">
                                ...
                                <form name="reserv_form" id="reserv_form" method="post" onSubmit="return false">
                                    <div class="col-md-6"><div class="field"><input name="reserv_name" id="reserv_name" type="text" value="Your Name" onblur="if (this.value == '') {
                                    ...
                                    <div class="col-md-6"><div class="field">
                                            <input type="text" id="datepicker"  placeholder="Appointment Date" onClick="" name="datepicker" value="Choose A Date" onblur="if (this.value == '') {
                                                                                                    this.value = 'Choose A Date'
                                                                                                }" onfocus="if (this.value == 'Choose A Date') {
                                                                                                            this.value = ''
                                                                                                        }"/>	
                                        </div></div>
                                    ...
                                    <div class="col-md-6"><div class="field"><input name="reserv_email" id="reserv_email" type="text" value="Email Address" onblur="if (this.value == '') {
                                                                                                    this.value = 'Email Address'}" onfocus="if (this.value == 'Email Address') {
                                                                                                                this.value = ''}"></div></div>
                                    <div class="col-md-6"><div class="field"><input name="reserv_phone" id="reserv_phone" type="text" value="Phone No" onblur="if (this.value == '') {
                                                                                                    this.value = 'Phone No'
                                                                                                }" onfocus="if (this.value == 'Phone No') {
                                                                                                            this.value = ''}"></div></div>
                    ...
                    <div class="row">
                        <div class="span12">
                            ...
                            <div id="owl-demo" class="owl-carousel">
                                ...
                                <div class="post item">
                                    <img class="lazyOwl" src="<?php echo $this->request->webroot; ?>chickenpot/images/news-img2.jpg" alt="">
                                    <div class="detail">
                                        <img src="<?php echo $this->request->webroot; ?>chickenpot/images/news-cheff2.jpg" alt="">
                                ...
                                <div class="post item">
                                    <img class="lazyOwl" src="<?php echo $this->request->webroot; ?>chickenpot/images/news-img3.jpg" alt="">
                                    <div class="detail">
                                        <img src="<?php echo $this->request->webroot; ?>chickenpot/images/news-cheff3.jpg" alt="">
                                ...
                                <div class="post item">
                                    <img class="lazyOwl" src="<?php echo $this->request->webroot; ?>chickenpot/images/news-img4.jpg" alt="">
                                    <div class="detail">
                                        <img src="<?php echo $this->request->webroot; ?>chickenpot/images/news-cheff2.jpg" alt="">
                                ...
                                <div class="post item">
                                    <img class="lazyOwl" src="<?php echo $this->request->webroot; ?>chickenpot/images/news-img5.jpg" alt="">
                                    <div class="detail">
                                        <img src="<?php echo $this->request->webroot; ?>chickenpot/images/news-cheff1.jpg" alt="">
