...
class AppController extends Controller {
    ...
    public function beforeRender(Event $event) {
        ...
        $this->set(compact('user_details','appCurController','SiteSettings', 'appCurActiion','appSlider','totReview','appReviews', 'appReviewsDt','revCount','appNews'));
   ...
   //  $sessin[] =  $this->set('session',$this->Session);
    // pr($sessin);die;   
    // $read = $this->Session->read('session');
    // pr($read);die;
   }
